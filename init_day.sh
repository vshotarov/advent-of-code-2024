...
user_agent="github.com/vshotarov/advent-of-code-2024 by vshotarov@gmail.com"
real_input=`curl --cookie "session=$aoc_cookie" --user-agent "$user_agent" https://adventofcode.com/2024/day/$1/input` &&
